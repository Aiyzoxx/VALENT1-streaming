export const THEME = {
  ...
  fonts: {
    regular: 'Poppins, -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, sans-serif',
    medium: 'Poppins, -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, sans-serif',
    semibold: 'Poppins, -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, sans-serif',
    bold: 'Poppins, -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, sans-serif',
    extrabold: 'Poppins, -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, sans-serif',
  },
  ...
  shadows: {
    filter: '0 4px 6px rgba(0, 0, 0, 0.3)',
    card: '0 8px 10px rgba(0, 0, 0, 0.4)',
    heroCard: '0 16px 20px rgba(0, 0, 0, 0.7)',
    glowPrimary: '0 4px 10px rgba(255, 255, 255, 0.25)',
  },
} as const;
